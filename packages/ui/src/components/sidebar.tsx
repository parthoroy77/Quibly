...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from "@quibly/ui/components/sheet";
import { Skeleton } from "@quibly/ui/components/skeleton";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@quibly/ui/components/tooltip";
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <SquareChevronLeft className={cn("transition-all duration-300", state === "collapsed" && "rotate-180")} />
